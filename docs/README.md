...
| 3 | [Bugs found](BUGS-FOUND.md) | Five fixed bugs, each with its commit. |
| — | [Measurement](measurement.md) | The Linux container run: tests, build,<br/>probe output, and what was not covered. |
